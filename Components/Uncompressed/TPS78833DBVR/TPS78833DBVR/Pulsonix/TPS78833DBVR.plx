...
(library Library_1
	...
	(compDef "TPS78833DBVR" (originalName "TPS78833DBVR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "SR") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tps788")
		(attr "<STEP Filename>" "TPS78833DBVR.stp")
